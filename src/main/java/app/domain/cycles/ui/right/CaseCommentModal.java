 ...
 */
public final class CaseCommentModal {
    ...
    public CaseCommentModal(Button anchorBtn) {
        this.anchorBtn = anchorBtn;
    }

    public void setBeforeOpen(Runnable r) {
        this.beforeOpen = (r == null) ? () -> {} : r;
    }

    public void setCurrentValueSupplier(Supplier<String> s) {
        if (s != null) this.currentValueSupplier = s;
    }

    public void setEditableSupplier(BooleanSupplier s) {
        if (s != null) this.editableSupplier = s;
    }

    public void setOnSaved(Consumer<String> c) {
    ...
    private void onBeforeOpen() {
        ...
        try { editable = editableSupplier.getAsBoolean(); } catch (Exception ignore) {}
        ...
        if (ta != null) {
            ...
            ta.setDisable(false);
            ta.setPromptText(editable ? I18n.t("cy.case.comment.placeholder") : "");
        }

        if (btnSave != null) {
            btnSave.setVisible(editable);
            btnSave.setManaged(editable);
        }
    ...
    private VBox buildModal() {
        ...
        ta.textProperty().addListener((obs, oldV, newV) -> updateSaveState());
    ...
    private void updateSaveState() {
        if (btnSave == null || ta == null) return;
